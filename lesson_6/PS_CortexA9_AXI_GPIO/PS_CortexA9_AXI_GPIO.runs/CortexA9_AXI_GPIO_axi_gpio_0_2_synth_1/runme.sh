...
HD_PWD='C:/Users/dcapr/vhdl-fpga-udemy/lesson_6/PS_CortexA9_AXI_GPIO/PS_CortexA9_AXI_GPIO.runs/CortexA9_AXI_GPIO_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CortexA9_AXI_GPIO_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CortexA9_AXI_GPIO_axi_gpio_0_2.tcl
