...
HD_PWD='C:/Users/dcapr/vhdl-fpga-udemy/lesson_6/PS_CortexA9_AXI_GPIO/PS_CortexA9_AXI_GPIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CortexA9_AXI_GPIO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CortexA9_AXI_GPIO_wrapper.tcl -notrace
