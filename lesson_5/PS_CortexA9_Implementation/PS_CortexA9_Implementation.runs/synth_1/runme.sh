...
HD_PWD='C:/Users/dcapr/vhdl-fpga-udemy/lesson_5/PS_CortexA9_Implementation/PS_CortexA9_Implementation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CortexA9_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CortexA9_wrapper.tcl
