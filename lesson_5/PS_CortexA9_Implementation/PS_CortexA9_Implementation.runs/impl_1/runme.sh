...
HD_PWD='C:/Users/dcapr/vhdl-fpga-udemy/lesson_5/PS_CortexA9_Implementation/PS_CortexA9_Implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CortexA9_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CortexA9_wrapper.tcl -notrace
